...
replace k8s.io/apiserver => github.com/openshift/kubernetes-apiserver v0.0.0-20231102175324-cd9a4f59dfdc

replace k8s.io/apimachinery => github.com/openshift/kubernetes-apimachinery v0.0.0-20231102175346-aebf00f76bee
